...
const Home = () => {
    return (
        <section className='select-none bg-cover bg-center bg-no-repeat bg-black ' style={{ backgroundImage: "url('/images/beautiful-selective-focus-shot-crystal-ball-reflecting-breathtaking-sunset.jpg')", 'fontFamily': 'var(--font-inter)' }}>
            <section className='relative bg-black/70 h-full  pb-10'>
                    ...
                    <div className='flex justify-center items-center flex-1 w-full'>
                        <div className='text-center md:px-4 px-8 md:min-w-[600px] min-w-[350px]'>
                            ...
                            <form className='md:flex gap-2 mt-4 max-w-lg mx-auto grid'>
                                ...
                                />
                                <button
                                    className='flex gap-2 items-center md:justify-center bg-red-700 rounded-md cursor-pointer px-6 py-3 text-white col-span-1'
                                >
