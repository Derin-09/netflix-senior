      ...
      {isClicked && active && (
        <div className="fixed top-0 left-0 w-full h-full bg-black/70 flex justify-center items-center z-50" >
          ...
          <section className='bg-black/40 p-6'>
            ...
            <Link href="/Presignup" className="inline-block">
              <button className="flex items-center gap-2 bg-red-700 px-4 py-2 rounded hover:bg-red-600 hover:cursor-pointer transition">
                Get Started
                <FaChevronRight />
              </button>
            </Link>
